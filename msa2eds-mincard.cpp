...
void print_eds(const vector<string>& msa, const vector<pair<int, int>>& segments) {
...
int main(int argc, char* argv[]) {
    ...
    if (argc<=1) {
      cout << "Syntax: " << string(argv[0]) << " msa.fasta segment-length-upper-bound (default " << U << ")" << endl;
      return 0;
    }
